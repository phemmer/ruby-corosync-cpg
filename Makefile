...
CFLAGS   = -fPIC -O2 -pipe -march=native -mmmx -fno-strict-aliasing -fPIC $(ARCH_FLAG)
INCFLAGS = -I. -I$(arch_hdrdir) -I$(hdrdir)/ruby/backward -I$(hdrdir) -I$(srcdir)
DEFS     = 
CPPFLAGS =   $(DEFS) $(cppflags)
CXXFLAGS = $(CFLAGS) -O2 -pipe -march=native -mmmx -fno-strict-aliasing
...
target_prefix = 
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -lcpg -lcorosync_common  -lpthread -lrt -ldl -lcrypt -lm   -lc
SRCS = CorosyncCPG.c
OBJS = CorosyncCPG.o
TARGET = CorosyncCPG
TARGET_NAME = CorosyncCPG
...
pre-install-rb-default:
	$(ECHO) installing default CorosyncCPG libraries
./.RUBYARCHDIR.time:
